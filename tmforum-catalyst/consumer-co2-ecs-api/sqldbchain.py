...
# this function is added to extract the correct the bug of langchain returing the SQLquery 
def extract_sql(sql: str) -> Optional[str]:
    anchor = '```sql'
